<?php
    ...
    $args = array(
        ...
        'menu_title'           => __( 'NewsPortal Setting', 'redux-framework-demo' ),
        'page_title'           => __( 'NewsPortal', 'redux-framework-demo' ),
    ...
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Site Logo', 'wp_newsportal' ),
        'id'               => 'logo',
        'subsection'       => true,
        ...
        'fields'           => array(
            array(
                ...
                'type'     => 'media',
                'title'    => __( 'Site Logo', 'wp_newsportal' ),
                'subtitle' => __( 'Upload Your Site Logo' ),
                 'url'      => true,
    ...
    Redux::setSection( $opt_name, array(
        'title'      => __( 'Social Link', 'wp_newsportal' ),
        'id'         => 'social',
        ...
        'fields'     => array(
            ...
            array(
                'id'       => 'facebook',
                'type'     => 'text',
                'title'    => __( 'Facebook URL', 'wp_newsportal' ),
                'subtitle' => __( 'This must be a URL.', 'wp_newsportal' ),
            ...
            array(
                'id'       => 'twitter',
                'type'     => 'text',
                'title'    => __( 'Twitter URL', 'wp_newsportal' ),
                'subtitle' => __( 'This must be a URL.', 'wp_newsportal' ),
            ...
            array(
                'id'       => 'google-plus',
                'type'     => 'text',
                'title'    => __( 'Google Plus URL', 'wp_newsportal' ),
                'subtitle' => __( 'This must be a URL.', 'wp_newsportal' ),
            ...
            array(
                'id'       => 'linkdin',
                'type'     => 'text',
                'title'    => __( 'Linkdin URL', 'wp_newsportal' ),
                'subtitle' => __( 'This must be a URL.', 'wp_newsportal' ),
 ...
 Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            array(
                ...
                'title'       => __( 'Slides Options', 'wp_newsportal' ),
                'subtitle'    => __( 'Unlimited slides with drag and drop sortings.', 'wp_newsportal' ),
                'desc'        => __( 'This field will store all slides values into a multidimensional array to use into a foreach loop.', 'wp_newsportal' ),

                
                'placeholder' => array(
                    'title'       => __( 'This is a Slider Caption', 'wp_newsportal' ),
    ...
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Home Page Section', 'wp_newsportal' ),
        'id'               => 'home-page',
        'subsection'       => true,
        ...
        'fields'           => array(
            ...
            array(
    'id'       => 'home-page-first-section-title',
    'type'     => 'text',
    'title'    => __('Select Home Page 1st Section Title', 
        'wp_newsportal' ),
    
),
           array(
    'id'       => 'home-page-first-section-category',
    'type'     => 'select',
    'data'     => 'categories',
    'title'    => __( 
        'Select Home Page 1st Section Category', 
        'wp_newsportal' 
     ),
    ...
    array(
    'id'       => 'home-page-second-section-title',
    'type'     => 'text',
    'title'    => __('Select Home Page 2nd Section Title', 
        'wp_newsportal' ),
    
),
           array(
    'id'       => 'home-page-second-section-category',
    'type'     => 'select',
    'data'     => 'categories',
    'title'    => __( 
        'Select Home Page 2nd Section Category', 
        'wp_newsportal' 
     ),
    
 ),
             array(
    'id'       => 'home-page-third-section-title',
    'type'     => 'text',
    'title'    => __('Select Home Page 3rd Section Title', 
        'wp_newsportal' ),
    
),
           array(
    'id'       => 'home-page-third-section-category',
    'type'     => 'gallery',
    
    'title'    => __( 
        'Select Home Page 3rd Section Category', 
        'wp_newsportal' 
     ),
    
 ),
             array(
    'id'       => 'home-page-fourth-section-title',
    'type'     => 'text',
    'title'    => __('Select Home Page 4th Section Title', 
        'wp_newsportal' ),
    
),
           array(
    'id'       => 'home-page-fourth-section-category',
    'type'     => 'select',
    'data'     => 'categories',
    'title'    => __( 
        'Select Home Page 4th Section Category', 
        'wp_newsportal' 
     ),
  ...
  array(
    'id'       => 'home-page-fifth-section-title',
    'type'     => 'text',
    'title'    => __('Select Home Page 5th Section Title', 
        'wp_newsportal' ),
    
),
           array(
    'id'       => 'home-page-fifth-section-category',
    'type'     => 'select',
    'data'     => 'categories',
    'title'    => __( 
        'Select Home Page 5th Section Category', 
        'wp_newsportal' 
     ),
  ...
  array(
    'id'       => 'home-page-sixth-section-title',
    'type'     => 'text',
    'title'    => __('Select Home Page 6th Section Title', 
        'wp_newsportal' ),
    
),
           array(
    'id'       => 'home-page-sixth-section-category',
    'type'     => 'select',
    'data'     => 'categories',
    'title'    => __( 
        'Select Home Page 6th Section Category', 
        'wp_newsportal' 
     ),
    
 ),
            array(
    'id'       => 'home-page-seveth-section-title',
    'type'     => 'text',
    'title'    => __('Select Home Page 7th Section Title', 
        'wp_newsportal' ),
    
),
               array(
    'id'       => 'home-page-seveth-section-category',
    'type'     => 'select',
    'data'     => 'categories',
    'title'    => __( 
        'Select Home Page 7th Section Category', 
        'wp_newsportal' 
     ),
    
 ),
                 array(
    'id'       => 'home-page-eighth-section-title',
    'type'     => 'text',
    'title'    => __('Select Home Page 8th Section Title', 
        'wp_newsportal' ),
    
),      
                   array(
    'id'       => 'home-page-eighth-section-category',
    'type'     => 'select',
    'data'     => 'categories',
    'title'    => __( 
        'Select Home Page 8th Section Category', 
        'wp_newsportal' 
     ),
    
 ),        array(
    'id'       => 'home-page-nineth-section-title',
    'type'     => 'text',
    'title'    => __('Select Home Page 9th Section Title', 
        'wp_newsportal' ),
    
),
                       array(
    'id'       => 'home-page-nineth-section-category',
    'type'     => 'select',
    'data'     => 'categories',
    'title'    => __( 
        'Select Home Page 9th Section Category', 
        'wp_newsportal' 
     ),
